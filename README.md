...
- the main Python code [Python_Heat_Transfert_Polar_Convection.py](Python_Heat_Transfert_Polar_Convection.py)
- the Matlab code base [Matlab_Heat_Transfert_Polar_convection_2D.m](Matlab_Heat_Transfert_Polar_convection_2D.m)
- the code that allows the differences between the two main codes to be perceived [Python_Matlab_Comparator.py](Python_Matlab_Comparator.py)
